...
final class CustomFieldGroupCreateInCardAction implements ActionInterface, AuthenticateInterface, ResponseResultInterface
{
    ...
    {
        return "api/cards/{$this->cardId}/custom-field-groups";
    }
